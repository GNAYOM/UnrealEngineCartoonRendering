	...
	bool bIsSupported)
{
	...
	else
	{
		...
		case MP_SubsurfaceColor:
			...
			break;
		case MP_CustomData0:
			Active = ShadingModels.HasAnyShadingModel({ MSM_Toon,MSM_ToonFace,MSM_ClearCoat, MSM_Hair, MSM_Cloth, MSM_Eye, MSM_SubsurfaceProfile });
			break;
		case MP_CustomData1:
			Active = ShadingModels.HasAnyShadingModel({ MSM_Toon,MSM_ToonFace,MSM_ClearCoat, MSM_Eye });
			break;
		case MP_EmissiveColor:
